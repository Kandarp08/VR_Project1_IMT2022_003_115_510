...
The methodology is discussed in detail, along with the results obtained. We have also compared the results of traditional techniques with deep learning methods.
...
`masked_face_segmentation.ipynb`: Code for segmentation tasks (Traditional techniques and U-Net)

`Output/PartC`: Segmented images generated by traditional techniques.
